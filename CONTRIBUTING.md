# Contributing to Awesome Ash

:+1: First off, thanks for taking the time to contribute! :+1:

The following is a set of guidelines for contributing to Awesome Ash.
...
Do you know any cool Ash project that isn't listed here? Please submit a pull request, we will be happy to receive it.
...
* Libraries that are compatible with latest Ash, hex-installable, tested and documented are preferred.
